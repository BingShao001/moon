...
public class AbstractInterfaceConfig extends AbstractConfig {
    ...
    protected String getLocalHostAddress() {
        ...
        if(address==null || StringUtils.isBlank(address.getHostAddress())){
            throw new RpcFrameworkException("retrieve local host address failure. Please config <moon:protocol host='...' />");
        }
    ...
    protected void checkApplication() {
        ...
        if (application == null) {
            throw new IllegalStateException(
                    "No such application config! Please add <moon:application name=\"...\" /> to your spring config.");
        }
